...
namespace TTT
{
    ...
    /// </summary>
    public class TTTVectorSensor : ISensor
    {
        ...
        public TTTVectorSensor(int observationSize, string name = null, ObservationType observationType = ObservationType.Default)
        {
